...
% This function creates a matrix with a circle section of pixels.
%
%  INPUTS 
% 
% 
...
p=inputParser;
validationFcn1 = @(x) isnumeric(x) && isscalar(x) && (x > 0); 
validationFcn2 = @(x) isnumeric(x) && isscalar(x) && (x > 0) && x<r1;
