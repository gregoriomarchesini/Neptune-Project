function result=KeyFinder(fits_info_obj,desired_key)
...
%  
% fits_info_obj     object obtained reading         fitsobject
%                   a fits file with fitsread
%
...
for i=1:r
    if strcmp(desired_key,table_key{i,1})
        ...
        fprintf('Returned results for %s : %s\n',desired_key,table_key{i,2})
